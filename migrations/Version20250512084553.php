 ...
 */
final class Version20250512084553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE showtime (id INT AUTO_INCREMENT NOT NULL, movie_id INT NOT NULL, room_id INT NOT NULL, date DATE NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, language JSON NOT NULL, projection_type VARCHAR(20) DEFAULT NULL, status VARCHAR(50) NOT NULL, available_seats INT NOT NULL, pmr_seats INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, special_price TINYINT(1) NOT NULL, special_prices JSON DEFAULT NULL, label VARCHAR(50) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, INDEX IDX_3248D918F93B6FC (movie_id), INDEX IDX_3248D9154177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
