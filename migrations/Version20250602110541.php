 ...
 */
final class Version20250602110541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE cinema (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, city VARCHAR(100) NOT NULL, address LONGTEXT DEFAULT NULL, postal_code VARCHAR(20) DEFAULT NULL, country VARCHAR(100) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE incident (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, showtime_id INT NOT NULL, room_id INT DEFAULT NULL, seat_id INT DEFAULT NULL, reported_by_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, resolved_at DATETIME DEFAULT NULL, category VARCHAR(255) NOT NULL, INDEX IDX_3D03A11AA76ED395 (user_id), INDEX IDX_3D03A11A28BE1523 (showtime_id), INDEX IDX_3D03A11A54177093 (room_id), INDEX IDX_3D03A11AC1DAFE35 (seat_id), INDEX IDX_3D03A11A71CE806 (reported_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, duration INT NOT NULL, release_date DATE NOT NULL, age_rating VARCHAR(5) DEFAULT NULL, poster_url LONGTEXT DEFAULT NULL, is_favorite TINYINT(1) NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, at_cinema TINYINT(1) NOT NULL, genre JSON NOT NULL, language JSON NOT NULL, hero_image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, cinema_id INT NOT NULL, name VARCHAR(100) NOT NULL, capacity INT NOT NULL, notes LONGTEXT DEFAULT NULL, projection_equipment JSON DEFAULT NULL, INDEX IDX_729F519BB4CB84B6 (cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE showtime (id INT AUTO_INCREMENT NOT NULL, movie_id INT NOT NULL, room_id INT NOT NULL, date DATE NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, language JSON NOT NULL, projection_type VARCHAR(20) DEFAULT NULL, status VARCHAR(50) NOT NULL, available_seats INT NOT NULL, pmr_seats INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, special_price TINYINT(1) NOT NULL, special_prices JSON DEFAULT NULL, label VARCHAR(50) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, chosen_language VARCHAR(10) DEFAULT NULL, INDEX IDX_3248D918F93B6FC (movie_id), INDEX IDX_3248D9154177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, avatar VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password LONGTEXT NOT NULL, birth_date DATE DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, address LONGTEXT NOT NULL, postal_code VARCHAR(20) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, country VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, last_login DATETIME DEFAULT NULL, is_active TINYINT(1) DEFAULT 0 NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
