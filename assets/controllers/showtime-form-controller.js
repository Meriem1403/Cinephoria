...
export default class extends Controller {
    ...
    connect() {
        // On edit page: movie is already selected, load its languages into the dropdown
        if (this.movieSelectTarget?.value) {
            this.render()
        }
    }
    ...
    async render() {
        ...
        const previousValue = this.languageTarget.value || ''
        ...
        try {
            ...
            languages.forEach(lang => {
                ...
                if (lang === previousValue) option.selected = true
                this.languageTarget.appendChild(option)
            })

            if (previousValue) this.languageTarget.value = previousValue
