    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return [
            ...
            Field::new('chosenLanguage')
                ...
                ->setFormTypeOptions([
                    'choices' => [], // Filled by JS from selected movie (admin/api/movie/{id}/languages)
                ...
                ->setHelp('Languages are loaded from the selected movie. Select a movie to see available options.')
                ->setColumns(6),
